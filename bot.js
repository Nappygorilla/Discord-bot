...
const WORKINK_KEY_URL = String(process.env.WORKINK_KEY_URL || 'https://work.ink/2WZq/no-context-key').trim();
...
const commands = [
  ...
  new SlashCommandBuilder().setName('key').setDescription('Get the NoContext free key link.'),
